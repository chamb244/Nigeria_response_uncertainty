...
rain
names(rain)
rainsum <-  rain[[c("rain.sum.2015", "rain.sum.2016", "rain.sum.2017", "rain.sum.2018",
                  "rain.sum.2019", "rain.sum.2020", "rain.sum.2021", "rain.sum.2022", 
                  "rain.sum.2023", "rain.sum.2024")]]
rainsum
names(rainsum)

compareGeom(rainsum, mprices)

# save to disk for use in modeling
writeRaster(rainsum,  "rainsum.tif", overwrite=TRUE)
writeRaster(mprices, "mprices.tif", overwrite=TRUE)
